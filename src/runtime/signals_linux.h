...
SigTab runtime·sigtab[] = {
	...
	/* 18 */	N, "SIGCHLD: child status has changed",
	/* 19 */	N, "SIGPWR: power failure restart",
	/* 20 */	N, "SIGWINCH: window size change",
	/* 21 */	N, "SIGURG: urgent condition on socket",
	/* 22 */	N, "SIGIO: i/o now possible",
	/* 23 */	0, "SIGSTOP: stop, unblockable",
	/* 24 */	N+D, "SIGTSTP: keyboard stop",
	/* 25 */	0, "SIGCONT: continue",
	/* 26 */	N+D, "SIGTTIN: background read from tty",
	/* 27 */	N+D, "SIGTTOU: background write to tty",
	/* 28 */	N, "SIGVTALRM: virtual alarm clock",
	/* 29 */	N, "SIGPROF: profiling alarm clock",
	/* 30 */	N, "SIGXCPU: cpu limit exceeded",
	/* 31 */	N, "SIGXFSZ: file size limit exceeded",
